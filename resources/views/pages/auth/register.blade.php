      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Buat akun mu sekarang dan kelola uang desa bersama Sikasdesa.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form" action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-3">
                    <input name="password_confirmation" type="password" class="form-control" placeholder="Password Confirmation" aria-label="Password">
                  </div>
